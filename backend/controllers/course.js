...
exports.createCourse = async (req, res) => {
    try {
        ...
        const imageUrl = "https://www.classcentral.com/report/wp-content/uploads/2022/05/Java-BCG-Banner.png";

        const imageUrl1 = "https://i.ytimg.com/vi/aRwJHB0jYKM/maxresdefault.jpg";
        ...
        const newCourse = await Course.create({
            ...
            tag, status, instructions, thumbnail: imageUrl1, createdAt: Date.now(),
        });
